...
export default function EnhancedEditor({
  ...
  return (
    <div className="w-full h-full flex flex-col">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="p-2 hover:bg-gray-100 rounded-full" title="More actions">
                <Fai icon="ellipsis-v" style="fal" />
              </button>
            </DropdownMenuTrigger>
      ...
      <div className="flex-1 overflow-auto p-4 border-t border-gray-200">
        {editorMode === 'visual' ? (
          <LexicalComposer initialConfig={initialConfig}>
            <ToolbarPlugin onCommand={executeCommand} activeAction={activeAction} />
            <CustomCommandsPlugin executeCommand={executeCommand} />
            <HtmlPlugin initialHtml={payload.content} onHtmlChange={handleLexicalChange} />
            <RichTextPlugin
              contentEditable={
                <ContentEditable
                  className="min-h-[400px] outline-none w-full"
      ...
      <div className="px-4 py-2 flex justify-between items-center border-t border-gray-200 text-sm text-gray-500">
        <div>
          Words: {wordCount} | Characters: {characterCount} | Reading Time: {readingTime} min
        </div>
        <div>
