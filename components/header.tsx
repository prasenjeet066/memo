    ...
    <div className = 'w-full p-4 flex flex-row items-center justify-between gap-4 sticky top-0 bg-white'>
      ...
      </div>
      {
        sideBarLogic && NavList.length && (
          ...
          <div className='min-w-[50%] bg-white/2 flex flex-col items-center backdrop-blur-md justify-start'>
            <ArrowLeft className='flex h-8 w-8 flex-row items-center justify-center p-4 bg-gray-700 rounded-full text-white' onClick={()=>{setSideBarOpenLogic(!sideBarLogic)}}/>
